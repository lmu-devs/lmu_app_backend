...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["sport_course_id"],
            ["sport_course.id"],
            name="sport_course_likes_sport_course_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["movie_screening_id"],
            ["movie_screenings.id"],
            name="movie_screening_likes_movie_screening_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["user_id"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["genre_id"],
            ["movie_genres.id"],
            name="movie_genre_associations_genre_id_fkey",
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["movie_id"],
