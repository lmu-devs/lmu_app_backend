...
class PublicHolidayService:
    ...
    def __init__(self, language: LanguageEnum = LanguageEnum.GERMAN):
        ...
        logger.info(f"Initializing holiday service for language {language} (country: {country_code}, state: {state_code})")
...
if __name__ == "__main__":
    ...
    print(public_holiday_service.is_public_holiday(date(2024, 12, 25)))
