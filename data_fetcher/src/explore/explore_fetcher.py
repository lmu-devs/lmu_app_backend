...
from data_fetcher.src.explore.services.explore_service import ExploreService
...
from shared.src.core.logging import get_explore_fetcher_logger


logger = get_explore_fetcher_logger(__name__)
...
async def create_explore_fetcher():
    logger.info("================================================")
