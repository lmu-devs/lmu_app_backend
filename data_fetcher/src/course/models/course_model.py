...
class Course(BaseModel):
    ...
    degree: Optional[List[str]] = Field(default=None, alias="Degree_of_completion_value", description="Degree awarded upon completion")
    language: Optional[List[str]] = Field(default=None, alias="Language_value", description="Primary language of instruction")
    description: Optional[List[str]] = Field(default=None, alias="Description_value", description="Brief course description")
    description_long: Optional[List[str]] = Field(default=None, alias="Description_long_value", description="Detailed course description")
    standard_period: Optional[List[str]] = Field(default=None, alias="standardPeriodOfStudy_value", description="Standard duration of studies")
