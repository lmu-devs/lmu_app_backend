from data_fetcher.src.food.constants.canteens.areas.opening_hours import (
    benediktbeuren_opening_hours, freising_opening_hours,
    garching_opening_hours, martinsried_grosshadern_opening_hours,
    munich_opening_hours, oberschleissheim_opening_hours, pasing_opening_hours,
