...
from .v2.sport.routers import sport_router as sport_router_v2
...
def create_app():
    ...
    app.include_router(sport_router_v2.router, prefix=prefix_v2, tags=["sport"])
    ...
    app.include_router(course_router.router, prefix=f"{prefix_v1}/course", tags=["courses"])
