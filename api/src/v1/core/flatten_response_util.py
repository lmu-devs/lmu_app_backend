...
def flatten_response(response: Dict[str, Any]) -> Union[Dict[str, Any], List[Any]]:
    ...
    Returns:
        The flattened data structure with 'data' wrapper and translations merged into their parent objects
    ...
    def _flatten_translations(data: Union[Dict[str, Any], List[Any]]) -> Union[Dict[str, Any], List[Any]]:
