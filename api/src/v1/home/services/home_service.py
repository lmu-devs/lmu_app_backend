        ...
        return Home(
            ...
            links=[
                ...
                Link(
                    ...
                    url="https://qissos.verwaltung.uni-muenchen.de/qisserversos/rds?state=change&type=1&moduleParameter=studentReportsMenu&nextdir=change&next=menu.vm&xml=menu&purge=y&subdir=qissos/reports&menuid=qissosreportsPublish&breadcrumb=qissosreports&breadCrumbSource=menu",
                ),
                Link(
                    title="LMU-Mail",
                ...
                Link(
                    title="Beitragskonto",
                    url="https://qissos.verwaltung.uni-muenchen.de/qisserversos/rds?state=gebkonto&asi=a$Lx1jxFA$kMP5tPiuVP",
                ),
                Link(
                    title="Benutzerkonto",
