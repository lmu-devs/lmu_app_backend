...
class CanteenService:
    ...
    async def get_canteen(self, canteen_id: str) -> CanteenTable:
        ...
        try:
            ...
            raise DatabaseError(
                detail="Failed to fetch canteen", extra={"original_error": str(e)}
            ) from e
    ...
    async def get_canteens(self, canteen_id: str = None) -> List[CanteenTable]:
        ...
        try:
            ...
            raise DatabaseError(
                detail="Failed to fetch canteen(s)", extra={"original_error": str(e)}
            ) from e
    ...
    async def toggle_like(self, canteen_id: str, user_id: uuid.UUID) -> bool:
        return await self.like_service.toggle_like(
            CanteenLikeTable, canteen_id, user_id
        )
