...
class CanteenService:
    ...
    async def get_canteen(self, canteen_id: str) -> CanteenTable:
        ...
        try:
            ...
            raise DatabaseError(detail="Failed to fetch canteen", extra={"original_error": str(e)}) from e
    ...
    async def get_canteens(self, canteen_id: str = None) -> List[CanteenTable]:
        ...
        try:
            ...
            raise DatabaseError(detail="Failed to fetch canteen(s)", extra={"original_error": str(e)}) from e
