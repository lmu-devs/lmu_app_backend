...
@router.post(
    "/canteens/toggle-like",
    response_model=bool,
    description="Authenticated user can toggle like for a canteen. Returns True if the canteen was liked, False if it was unliked.",
)
async def toggle_like(
    canteen_id: str = Query(
        ...,
        description="Canteen ID to toggle like",
        example="mensa-leopoldstr",
