...
class NotificationCreate(NotificationBase):
    ...
    translations: Optional[List[NotificationTranslationCreate]] = Field(None, description="Additional translations for the notification")
...
class NotificationResponse(NotificationBase):
    ...
    translations: List[NotificationTranslationResponse] = Field(default_factory=list, description="Translations of this notification")
